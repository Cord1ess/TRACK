...
| 6 | Collection runs on GitHub Actions every 10 minutes and the site is GitHub Pages. | Free, no server to keep alive. A capture takes 13 minutes, so runs queue and the site updates about every 15 minutes. |
